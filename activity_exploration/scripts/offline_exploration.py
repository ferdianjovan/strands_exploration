...
import argparse
import datetime
from periodic_poisson_processes.synthetic import WeeklySyntheticData
from spectral_analysis.spectral_processes import SpectralPoissonProcesses
...
class OfflineExploration(object):
    ...
    def __init__(
        ...
        self.offline = OfflinePeoplePoisson(
